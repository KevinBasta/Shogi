...
export class board { 
    ...
    turnManagePieceClick(goteOrSente) { 
        for (let piecePosition in this.gameBoard) { 
            if (currentTurn === "sente" && this.gameBoard[piecePosition].getGoteSente() === "sente") { 
                addPieceEventListener(piecePosition);
                pieceClickable(piecePosition);
            } else if (currentTurn === "gote" && this.gameBoard[piecePosition].getGoteSente() === "gote") { 
                addPieceEventListener(piecePosition);
                pieceClickable(piecePosition);
            } else { 
                removePieceEventListener(piecePosition);
                opponentPieceUnclickable(piecePosition);
            }
        }
